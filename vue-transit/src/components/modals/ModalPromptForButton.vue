...
<template>
  <div class="prompt_wrapper">
    <div class="prompt_content text_size_msg my-4">
      <ul
        class="prompt_list w-full mx-auto flex flex-col justify-center items-center text-center gap-1 md:gap-2"
      >
      ...
      <div class="btn_wrapper w-4/5 mx-auto my-4 md:my-8 flex justify-center gap-2">
        <button
          class="btn_gen_green_2 text_size_msg w-16 md:w-40 text-center"
